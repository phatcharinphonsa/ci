...
<div class="container">
  ...
  <center><img src="https://media.istockphoto.com/vectors/man-using-protective-surgical-mask-for-covid-19-shield-with-particles-vector-id1248198864?k=20&m=1248198864&s=170667a&w=0&h=TzpBlHg-opAnkW9bT9o09V9Z6DeeC2aYwY-1hbXAOt4=" width="550" height="550">
	...
	<input type="text"  class="form-control" name="id" style="width:400px;" placeholder="รหัสบัตรประจำตัวประชาชน" value="<?php echo $id; ?>">
</div>
<div>
<br><br><br><br><br><br>
<div class="form-group">
  <div class="col-sm-6">
	...
	<input type="text" class="form-control" name="name" style="width:400px;" placeholder="ชื่อ - สกุล" value="<?php echo $name; ?>">
  </div>
      </div>
      <br><br><br><br>
      <div class="form-group">
	...
	<input type="date" class="form-control" name="day" style="width:400px;"  placeholder="วัน / เดือน / ปีเกิด" value= "<?php echo $day; ?>">
  </div>
      </div>
      <br><br><br><br>
      <div class="form-group">
	...
	<input type="email"class="form-control" name="email" style="width:400px;" placeholder="อีเมลล์" value="<?php echo $email; ?>">
  </div>
</div>
<br><br><br><br>
		<div class="form-group">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" class="form-control" name="phone" style="width:400px;" placeholder="เบอร์ติดต่อ" value="<?php echo $phone; ?>">
  </div>
    </div>
    <br><br><br><br>
		<div class="form-group">
	...
	<textarea type="textarea"class="form-control" name="address" style="width:400px;" placeholder="ที่อยู่ที่สามารถติดต่อได้" rows="6" value="<?php echo $address; ?>"></textarea>
		</div>
</div>
    <br><br><br><br><br><br><br><br><br><br><br><br>
		<div class="form-group">
			<div class="col-sm-6">
	<label for="krom">แผนประกัน ( Insurance plan ) </label>
	<input type="text"class="form-control" name="krom"style="width:400px;" placeholder="แผนประกัน" value="<?php echo $krom; ?>">
  </div>
    </div>
    <br><br><br><br>
    <div class="form-group">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น"class="form-control" name="price" style="width:400px;" placeholder="ราคาประกัน"value= "<?php echo $price; ?>">
		</div>
</div>
		<br>
		<br>
