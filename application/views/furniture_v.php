...
<div id="myPage" data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <center><h4 class="card-header">เฟอร์นิเจอร์</h4><center>
<div class="row">
  <div class="col-sm-2">
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><?php echo $row->Fur_num; ?></td>
        <td><?php echo $row->Fur_pricebuy; ?></td>
        <td><?php echo $row->Fur_pricesale; ?></td>
       
        
        <tb><a class="btn btn-warning" href='formEdit?Fur_id=<?php echo $row->Fur_id; ?>'>edit</a></tb>
        <tb><a class="btn btn btn-danger" href='formDelete?Fur_id=<?php echo $row->Fur_id; ?>'>delete</a></tb>
        </td>
    </tr>
