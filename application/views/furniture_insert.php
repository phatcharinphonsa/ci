...
<h3 class="text-center">เฟอร์นิเจอร์</h3>
<div class="container">
      <div class="row">
      <div class="col-sm-6" >
  <br><br><br>
	...
	<input type="text" title="กรอก" class="form-control" name="Fur_id" maxlength="13" style="width:400px;" placeholder="รหัสเฟอร์นิเจอร์" required>
        </div>
            </div>
    <br><br><br><br>
	...
	<input type="text" class="form-control" name="Fur_name" style="width:400px;" placeholder="ชื่อเฟอร์นิเจอร์" required>
            </div>
        </div>
<br><br><br><br>
	...
	<input type="text" class="form-control" name="Fur_num" style="width:400px;" placeholder="จำนวน" required>
		    </div>
        </div>
      <br><br><br><br>
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" class="form-control" name="Fur_pricebuy"  style="width:400px;" placeholder="ราคา" required>
		    </div>
        </div>
    <br><br><br>
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" class="form-control" name="Fur_pricesale"  style="width:400px;" placeholder="ราคา" required>
		    </div>
        </div>
