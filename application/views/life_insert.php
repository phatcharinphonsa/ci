...
<div class="container">
  ...
  <center><img src="https://image.makewebeasy.net/makeweb/m_750x0/BFBrAWbeP/Home/%E0%B8%9B%E0%B8%A3%E0%B8%B0%E0%B8%81%E0%B8%B1%E0%B8%99%E0%B8%8A%E0%B8%B5%E0%B8%A7%E0%B8%B4%E0%B8%95_%E0%B8%95%E0%B8%A5%E0%B8%AD%E0%B8%94%E0%B8%8A%E0%B8%B5%E0%B8%9E.png?v=202012190947" width="550" height="550">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" class="form-control" name="l_id" style="width:400px;" placeholder="รหัสบัตรประจำตัวประชาชน">
</div>
    </div>
    <br><br><br><br><br><br>
<div class="form-group">
  <div class="col-sm-6">
	...
	<input type="text" class="form-control" name="l_name" style="width:400px;" placeholder="ชื่อ - สกุล">
		</div>
      </div>
      <br><br><br><br>
<div class="form-group">
	...
	<input type="date" class="form-control" name="l_day" style="width:400px;"  placeholder="วัน / เดือน / ปีเกิด">
		</div>
    </div>
    <br><br><br><br>
		<div class="form-group">
	...
	<input type="email"class="form-control" name="l_email" style="width:400px;" placeholder="อีเมลล์">
</div>
</div>
<br><br><br><br>
		<div class="form-group">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น" class="form-control" name="l_phone" style="width:400px;" placeholder="เบอร์ติดต่อ">
		</div>
    </div>
    <br><br><br><br>
		<div class="form-group">
	...
	<textarea type="textarea"class="form-control" name="l_address" style="width:400px;" placeholder="ที่อยู่ที่สามารถติดต่อได้" rows="6"></textarea>
		</div>
    </div>
	...
	<input type="text"class="form-control" name="l_krom" style="width:400px;" placeholder="แผนประกัน">
		</div>
    </div>
    <br><br><br><br>
    <div class="form-group">
	...
	<input type="text" pattern="[0-9]{1,}" title="กรอกตัวเลขเท่านั้น"class="form-control" name="l_price" style="width:400px;" placeholder="ราคาประกัน"><br> 
		</div>
    </div>
